...
export default function RootFreeTrailPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`/api/get-free-trail-email`, {
                method: 'POST',
                body: formDataToSend,
            });
        ...
        <div className="container mx-auto p-5">
            ...
            >
                <h2 className="text-2xl font-semibold mb-6 text-gray-800">
                    Photo editing service you need
                </h2>
                ...
                >
                    {isLoading
                        ? 'Submitting Free Trail Request...'
                        : 'Submit Free Trail Request'}
                </button>
            </form>
        </div>
    );
